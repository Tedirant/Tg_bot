...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Игнорируем тебя
    if user.username and user.username.lower() == "turboos".lower() or user.username.lower() == "Ssssszx4".lower() or user.username.lower() == "tedirant".lower() or user.username.lower() == "dsgsfg1":
        return
